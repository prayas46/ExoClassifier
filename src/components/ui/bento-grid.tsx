...
const BentoCard = ({
  ...
  >
    ...
    <div className={cn(
      ...
      !noHover && "group-hover:-translate-y-10"
    )}>
      <Icon className={cn(
        "h-12 w-12 origin-left transform-gpu text-primary transition-all duration-300 ease-in-out",
        !noHover && "group-hover:scale-75"
      )} />
